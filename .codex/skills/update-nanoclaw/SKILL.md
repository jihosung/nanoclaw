...
- **Skills** (`.codex/skills/`): unlikely to conflict unless you edited an upstream skill
...
- **Skills** (`.codex/skills/`): unlikely to conflict unless the user edited an upstream skill
...
Present these buckets to the user and ask them to choose one path using Ask:
...
- Ask the user to ask the user which migration skills they want to run now. Options:
...
- Ask the user to ask: "Upstream has skill branches. Would you like to check for skill updates?"
